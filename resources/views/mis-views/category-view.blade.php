	...
	<body>
		...
		<div class="main-container">
            <div class="container-fluid">
                <?php foreach ($products[$category] as $element => $item){ ?>
                    <div class="container-sm">
                        <h3><?php echo htmlentities($item['nombre']) ?></h3>
                        <p>
                            <?php echo htmlentities($item['descripcion']); ?>
                        </p>
                        ...
                        <span class="pequenio_precio">
                            Q. <?php echo number_format($item['precio'], '2', '.', ','); ?>
                        </span>
                    </div>
                <?php } ?>
            </div>
